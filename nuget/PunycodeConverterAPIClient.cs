...
namespace APIVerve.API.PunycodeConverter
{
    ...
    /// <summary>
    /// Client for the PunycodeConverter API
    /// </summary>
    public class PunycodeConverterAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/punycode";
        ...
        {
            { "text", new ValidationRule { Type = "string", Required = true, MaxLength = 1000 } },
        ...
        public PunycodeConverterAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public PunycodeConverterAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public PunycodeConverterAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, PunycodeConverterQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(PunycodeConverterQueryOptions options)
        {
        ...
        public ResponseObj Execute(PunycodeConverterQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(PunycodeConverterQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(PunycodeConverterQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(PunycodeConverterQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(PunycodeConverterQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(PunycodeConverterQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(PunycodeConverterQueryOptions options)
        {
