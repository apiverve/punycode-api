// Package punycode provides a Go client for the Punycode Converter API.
//
// For more information, visit: https://apiverve.com/marketplace/punycode?utm_source=go&utm_medium=readme
package punycode
...
const (
	baseURL        = "https://api.apiverve.com/v1/punycode"
	defaultTimeout = 30 * time.Second
)

// Client is the Punycode Converter API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Punycode Converter API client.
...
// Execute makes a request to the Punycode Converter API with typed parameters.
//
...
//   - text (required): string - Unicode text or domain to encode (max 1000 characters) [maxLength: 1000]
