# Punycode Converter Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:punycode-api:1.1.13'
}
```
...
```java
import com.apiverve.punycode.PunycodeConverterAPIClient;
import com.apiverve.punycode.APIResponse;
import com.apiverve.punycode.APIException;

// Initialize the client
PunycodeConverterAPIClient client = new PunycodeConverterAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("text", "münchen.de");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/punycode](https://docs.apiverve.com/ref/punycode)
...
- **Documentation:** [https://docs.apiverve.com/ref/punycode](https://docs.apiverve.com/ref/punycode)
- **Issues:** [GitHub Issues](https://github.com/apiverve/punycode-api/issues)
