...
class punycodeWrapper {
    ...
    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/punycode');
        }
        ...
        this.validationRules = {"text":{"type":"string","required":true,"maxLength":1000},"mode":{"type":"string","required":false,"default":"encode"}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/punycode`);
        }
    }
...
module.exports = punycodeWrapper;
